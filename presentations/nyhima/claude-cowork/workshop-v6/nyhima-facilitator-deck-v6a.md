...
"Before anything else — think about the last time AI showed up in
...
```
1. Upload your file. "Summarize the structure. What's in here?"
   Try: "Show me only the New York hospitals." (Did it actually filter? Check.)
2. Pick a story it could tell. "I want to compare ___ to ___."
3. "Make a one-page memo with a chart that tells that story to leadership."
4. Note your one finding — the number or pattern you're carrying to Round 2.
```
...
- [ ] **[BUILD]** Shared Google Doc — *optional, add if logistics allow.*
- [ ] **[PRINT]** Numbered cards for the door — *optional, add if logistics allow.*
...
- **Round 2 redesigned around the data story.** The instruction is now one sentence
  — *"Here's the data story I found in Round 1. Tell me what this story means in the
  context of this document."* The task is application, not compression. The Four documents in the library: BAA, Breach Notification Rule, 42 CFR § 482.24, and the ICD-10-CM POA excerpt.
