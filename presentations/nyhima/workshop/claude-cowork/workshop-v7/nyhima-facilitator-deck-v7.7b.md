...
id: facilitator-deck
type: facilitator
title: Reading and Writing with AI — Facilitator Deck (v7.7)
event: NYHIMA Workshop
date: June 7, 2026 | 1:00–4:00 PM
presenter: Steve Schneider, SUNY Poly AIX Center
structure: three rounds (Interrogate / Interpret / Iterate)
parent: nyhima-facilitator-deck-v7.md
revision_notes: nyhima-v6-notes-001.md, nyhima-v6-notes-002.md
status: v7.7 — short link corrected to tiny.cc/nyhima26ai throughout; Slide 3 icebreaker rebuilt as participant-run copy/paste workflow (open tiny.cc → workshop-prompts → hello.md → copy → Gemini → paste)
---

# Reading and Writing with AI
## Facilitator Deck — v7.7
### NYHIMA Workshop | Sunday, June 7, 2026 | 1:00–4:00 PM | Steve Schneider, SUNY Poly AIX Center

The workshop runs three self-directed rounds:
...
|---------|------|------------|
| Opening | 10 min | 1:10 |
| Icebreaker + infrastructure | 30 min | 1:40 |
| Round 1 — **Interrogate** (data) | 30 min | 2:10 |
| Round 2 — **Interpret** (text) | 30 min | 2:40 |
| Round 3 — **Iterate** (the linked story) | 30 min | 3:10 |
| Wrap — the meta-moment | 25 min | 3:35 |
| Buffer | 25 min | 4:00 |

The rounds are a chain — Round 1's finding feeds Round 2, which feeds Round 3.
Protect that hand-off when you debrief: name out loud what carries forward from each
round into the next.
...
Everything lives at **https://tiny.cc/nyhima26ai**
...
**Now run the icebreaker yourself** — this is your first copy/paste, and it's the
whole workflow you'll use all day:

> ### 1. Open **https://tiny.cc/nyhima26ai**
> ### 2. Navigate to **workshop-prompts**
> ### 3. Open **hello.md** → select all → copy
> ### 4. Open **Gemini** (gemini.google.com)
> ### 5. Paste → send

"That's the loop. Open the prompt, copy it, paste it into Gemini, run it. You'll do
that same five-step move every round today — the prompts just get more interesting.

The prompt you just ran says:

> *I am a health information management professional. Define HIM for someone who
> has never heard the term.*

Notice it. **I am** — not **you are**. You're telling the model who's asking, not
assigning it a costume. That changes what comes back. Compare what a few of you got."

**Infrastructure, quickly:**

| What | Where |
|------|-------|
| Everything | https://tiny.cc/nyhima26ai |
...
| Tab | What's in it |
|-----|--------------|
| 1 | https://tiny.cc/nyhima26ai — your materials hub |
...
# SLIDE 6 — ROUND 1: INTERROGATE
*(30 min · self-directed · data)*

> ## Interrogate the data

**Model:** Gemini (free) — it can do math on a file you upload.
**Data:** five real CMS files in **https://tiny.cc/nyhima26ai → data**. Pick **one**.
...
# SLIDE 9 — FACILITATOR PREP: FIVE THINGS THE MODEL WILL GET WRONG
...
# SLIDE 10 — ROUND 2: INTERPRET
*(30 min · self-directed · text)*

> ## Interpret — carry your finding into the document

**Model:** Gemini (free).
**Document:** pick one from **https://tiny.cc/nyhima26ai → documents** — a real, dense HIM
...
**The pairings — one primary document per data file:**

| Round 1 data file | Pairs with | The question it raises |
|---|---|---|
| **Complications & Deaths** | 42 CFR § 482.24 | What does the condition-of-participation require for documentation behind these outcomes? |
| **Maternal Health** | 42 CFR § 482.24 | Same standard — does the record support what's being reported? |
| **Hospital Readmissions (HRRP)** | Business Associate Agreement | Who can touch this data, and under what terms, once it leaves your hands? |
| **Healthcare-Associated Infections (HAI)** | Breach Notification Rule | When reported data is wrong or exposed, what is triggered? |
| **Patient Safety Indicators (PSI-6)** | ICD-10-CM POA excerpt | Does present-on-admission coding change what this rate actually means? |

*[Facilitator — these are primary pairings, not assignments. 42 CFR § 482.24
covers two files. Steer a stuck table toward its pairing; don't announce the
pairings up front — half the work is choosing the document the finding raises a
question about.]*
...
# SLIDE 16 — IF YOU'RE AHEAD: TWO ENCORES
*(only for tables that finish early — not required)*

**Encore A — Judgment.** Pick a scenario in **https://tiny.cc/nyhima26ai → judgment** (J1–J4).
...
**Stay in touch:**
- Folder stays live — **https://tiny.cc/nyhima26ai**
...
- [ ] **[SETUP]** https://tiny.cc/nyhima26ai → folder with the five data files, the document library, system prompts, this run of show.
...
# APPENDIX B — WHAT CHANGED FROM v7

- **Short link corrected.** All instances updated to **https://tiny.cc/nyhima26ai** (was tiny.cc/nyhima).
- **Slide 3 icebreaker rebuilt as a hands-on workflow.** Participants now run their first copy/paste themselves — open tiny.cc → workshop-prompts → **hello.md** → copy → Gemini → paste — instead of watching it on the projector. The "I am / not you are" lesson is retained as a debrief of what they just ran. New companion file: `hello.md` in the workshop-prompts folder.
- **Lightning round removed entirely.** The 25-minute guided demo (old Slide 7) is gone. Its time was redistributed: Icebreaker 20 → 30 min, Round 3 Iterate 25 → 30 min, Wrap 15 → 25 min. Buffer unchanged at 25 min; day still ends at 4:00.
- **Slides renumbered** sequentially with no gaps (1–18). The old 5 → 7 jump and the "10b" prep slide are gone.

---

# APPENDIX C — WHAT CHANGED FROM v6
...
# APPENDIX D — WHAT CHANGED FROM v5
